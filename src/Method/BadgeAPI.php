...
class BadgeAPI
{
     ...
     */
    public function getBadges($params = ['site' => 'stackoverflow', 'sort' => 'rank', 'order' => 'desc'])
    {
     ...
     * @return array<BenatEspina\StackExchangeApiClient\Model\Interfaces\BadgeInterface>
     */
    public function getBadgesByIds($ids, $params = ['site' => 'stackoverflow', 'sort' => 'rank', 'order' => 'desc'])
    {
     ...
     * @return array<BenatEspina\StackExchangeApiClient\Model\Interfaces\BadgeInterface>
     */
    public function getNamedBadges($params = ['site' => 'stackoverflow', 'sort' => 'rank', 'order' => 'desc'])
    {
     ...
     * @return array<BenatEspina\StackExchangeApiClient\Model\Interfaces\BadgeInterface>
     */
    public function getRecipientBadges($params = ['site' => 'stackoverflow', 'sort' => 'rank', 'order' => 'desc'])
    {
    ...
    public function getRecipientBadgesByIds(
        $ids,
        $params = ['site' => 'stackoverflow', 'sort' => 'rank', 'order' => 'desc']
    ) {
     ...
     * @return array<BenatEspina\StackExchangeApiClient\Model\Interfaces\BadgeInterface>
     */
    public function getTagBasedBadges($params = ['site' => 'stackoverflow', 'sort' => 'rank', 'order' => 'desc'])
    {
